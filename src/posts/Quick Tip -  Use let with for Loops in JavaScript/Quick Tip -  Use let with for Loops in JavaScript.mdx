...
If you had an AJAX request where you are looping through a few of them, there isn't any way without an IIFE to reference what the `i` variable was when it ran, not what it currently is after the loop.
